    ...
    return ( 
        ...
        <div className="crewContentWrapper">
            <div className="crewCTA">
                <p className="crewHeading5"><span className="crewNumberHeading">03</span> MEET YOUR CREW</p>
                <div>
                <p className="crewHeading4">FLIGHT ENGINEER</p>
                <p className="crewHeading3">ANOUSHEH ANSARI</p>
                </div>
                <p className="crewBodyText">Anousheh Ansari is an Iranian American engineer and co-founder of Prodea Systems. Ansari was the fourth self-funded space tourist, the first self-funded woman to fly to the ISS, and the first Iranian in space. </p>
            ...
            <div className="VictorCrewImageWrapper">
                <img className="VictorCrewImage" src={msAnousheh} alt="victor glover" />
            </div>
        </div>
    </div>
     );
